...
from alminasascrapper.chain import search_chain 
...
def parse_arguments() -> argparse.Namespace:
    ...
    """
    parser = argparse.ArgumentParser(description="Scrape chain data")
    parser.add_argument('--data_csv', type=str, default="data/hadith_data_iden_bookwise.csv", help="Path of bookwise hadth iden data")
    parser.add_argument('--data_dir', type=str, default="data/chain_data", help="Directory to store scraped data.")
